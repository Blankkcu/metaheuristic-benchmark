...
def afiseaza_statistici(nume, rezultate):
...
def test_rucsac():
    ...
    afiseaza_statistici("Hill Climbing", rez_hc)
    afiseaza_statistici("Tabu Search", rez_ts)
    afiseaza_statistici("Simulated Annealing", rez_sa)
    afiseaza_statistici("Iterated Local Search", rez_ils)
    print("\n")
